...
if __name__ == "__main__":
    # Usage: python calculate_gc_content.py <regions_bed> <output_csv> <genome_fasta>
    ...
    if len(sys.argv) < 4:
        print("Usage: python calculate_gc_content.py <regions_bed> <output_csv> <genome_fasta>")
        print("Example: python calculate_gc_content.py ./data/processing/openchrom_with_id.bed ./data/processing/gc_content_per_region.csv ./data/hg19/hg19.fa")
        sys.exit(1)
