...
echo "Preparing liftover, ATAC-seq, and DNase-seq files"
...
echo "Creating open chromatin region pool from ATAC-seq and DNase-seq peaks"
...
python calculate_gc_content.py ./data/processing/openchrom_with_id.bed ./data/processing/gc_content_per_region.csv ./data/hg19/hg19.fa
